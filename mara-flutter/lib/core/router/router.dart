...
import 'package:mara_flutter/features/onboarding/onboarding_screen.dart';
...
// Legacy reference kept for convenience (onboarding already done by default)
final router = buildRouter(showOnboarding: false);
...
GoRouter buildRouter({bool showOnboarding = false}) => GoRouter(
      ...
      routes: [
        ...
        GoRoute(
            path: '/counselor',
            builder: (_, __) => const CounselorDashboard()),
        GoRoute(
            path: '/observatory',
            builder: (_, __) => const ObservatoryScreen()),
        ShellRoute(
          ...
          routes: [
            ...
            GoRoute(
                path: '/offline', builder: (_, __) => const OfflineScreen()),
